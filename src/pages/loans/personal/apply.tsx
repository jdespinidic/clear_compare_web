...
export default function PersonalLoanApplyPage() {
  return (
    <>
      <Head>
        <title>Compare Personal Loans | ClearCompare</title>
        <meta name="description" content="Compare personal loan offers from multiple lenders and find your best rate." />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
      </Head>

      <div className="min-h-screen bg-white font-opensans">
        {/* Header - Hidden */}
        <header className="hidden border-b border-light-orange bg-white/95 backdrop-blur-sm sticky top-0 z-50 safe-area-inset-top">
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-6">
              <h1 className="text-3xl md:text-4xl font-opensans-bold text-dark-gray mb-4">
                Compare Personal Loan Options in <span className="text-primary-orange">60 Seconds</span>
              </h1>
              <p className="text-lg text-medium-gray leading-relaxed font-opensans">
                We help you filter out the noise so you can understand options without impacting your credit score.
              </p>
            ...
            <div className="bg-white overflow-hidden relative" style={{ height: "calc(100vh - 200px)", minHeight: "700px" }}>
              <div className="absolute inset-0 overflow-hidden">
                <iframe src="https://platform.ratematch.ai/embed/clear-compare/apply/personal"
