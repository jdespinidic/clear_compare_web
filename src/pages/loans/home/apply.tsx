...
export default function HomeLoanApplyPage() {
  return (
    <>
      <Head>
        <title>Compare Home Loans | ClearCompare</title>
        <meta name="description" content="Compare home loan offers from multiple lenders and find your best rate." />
        ...
        <section className="px-4 sm:px-6 lg:px-8 py-8">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-6">
              <h1 className="text-3xl md:text-4xl font-avenir-heavy text-dark-gray mb-4">
                Compare Home Loans
              </h1>
              <p className="text-lg text-medium-gray leading-relaxed font-avenir">
                Get matched with competitive home loan offers from trusted lenders
              </p>
              <div className="mt-4 flex items-center justify-center">
                <p className="text-sm text-medium-gray font-avenir flex items-center">
                  Powered by{" "}
                  <span className="text-primary-orange font-avenir-medium ml-1">RateMatch</span>
                  <Image 
                    src="/symbol.png" 
            ...
            <div className="bg-white overflow-hidden relative" style={{ height: "calc(100vh - 200px)", minHeight: "700px" }}>
              <div className="absolute inset-0 overflow-hidden">
                <iframe src="https://platform.ratematch.ai/embed/clear-compare/apply/home"
